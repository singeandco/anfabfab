...
<div  style="float: right;" class="margin10">
    <a id="listeThemes" class="lienDecore " href="<?php echo url_for('main/index') ?>">Liste des articles</a>
</div>
...
<div class="margin10">
    ...
    <?php if (count($articles) == 0): ?>
        <h2 class="margin10">Aucun article contenant  "<?php echo $chaine ?>"</h2>
    <?php else: ?>

        <h2 class="margin10">Articles contenant "<?php echo $chaine ?>"</h2>
        <hr>
        <br />
